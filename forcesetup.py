'''
This version of the code will force the setup process first!
You should only use this script if you are running it on a program that attempts to automatically install modules for you, interfearing with setup in the original version.
Why? This version will take longer to boot up.
...
print("\nI'm done installing everything you need!") #This lets the user know to restart
